...
function submit() {
    form.post(route('admin.users.update', props.user.id), {
        forceFormData: true,
        // Spoof PUT para Laravel con FormData
...
<template>
    <AppLayout>
        <div class="page">
            ...
            <div class="page-head">
                <div>
                    <h1 class="page-head__title">Editar usuario</h1>
                    <p class="page-head__sub">Modifica los datos de <strong>{{ user.name }}</strong>.</p>
                </div>
            ...
            <form @submit.prevent="submit" class="card" novalidate>
                ...
                <div class="section">
                    ...
                    <div class="avatar-row">
                        <div class="avatar-lg" @click="pickAvatar" role="button" tabindex="0"
                             @keydown.enter="pickAvatar" aria-label="Cambiar foto">
                            <img v-if="avatarPreview" :src="avatarPreview"
                                 :alt="user.name" width="64" height="64" loading="lazy" />
                ...
                <div class="section">
                    ...
                    <div class="grid-2">
                        ...
                        <AppInput id="email" v-model="form.email" label="Correo electrónico"
                                  type="email" placeholder="correo@ejemplo.com" :error="form.errors.email">
                            <template #icon>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="section">
                    <h2 class="section__title">
                        Nueva contraseña
                        <span class="section__optional">(opcional — dejar vacío para no cambiar)</span>
                    </h2>
                    <div class="grid-2">
...
.section__title    { font-size: var(--text-sm); font-weight: 600; color: var(--color-text); display: flex; align-items: baseline; gap: var(--space-2); flex-wrap: wrap; }
.section__optional { font-size: var(--text-xs); font-weight: 400; color: var(--color-text-faint); }
...
.toggle       { display: flex; align-items: center; gap: var(--space-3); cursor: pointer; margin-top: var(--space-2); }
